...
def speedtest(update, context):
    ...
    ed_msg = message.reply_text("Sedang adu cepat . . . ")
    test = Speedtest()
    ...
    path = (result['share'])
    string_speed = f'''
<b>Server Kami host sekarang</b>
<b>Nama Server:</b> <code>{result['server']['name']}</code>
...
<b>Peringkat ISP:</b> <code>{result['client']['isprating']}</code>
'''
    ed_msg.delete()
    try:
